...
actualOutput = actualOutput.replaceAll("\\s+", " ").trim();
    ...
    @Test
    public void testMain_17() throws Exception {
        ByteArrayOutputStream outContent = new ByteArrayOutputStream();
        setOutput(new ByteArrayInputStream("2\nadmin\nAstralTrapez0idB0dy\n2\n06-12-2023\n13\n1\n1\n1\n2\n1\n3\n1\n4\n1\n5\n0\n1\nalice\nPassword123\n1\n1\n06-12-2023\n15\nCC\n3\n1\n0\n0\n0\n".getBytes()), outContent);
        Main.main(new String[] {}); // Run the main method which should now use the simulated input
        ...
        String expectedOutput = "Shahbagh Sports Complex\n"
        		...
        		+ "Press 0 to log out.\n"
        		+ "Input: "
        		+ "Enter the date you want to change to (DD-MM-YYYY): "
        		+ "Enter the hour you want to change to (If you want to change hour to 13:00, enter 13): "
        		+ admin.printTime()
        		+ "\n"
        		+ "Press 1 to add a facility.\n"
        		+ "Press 2 to change system time.\n"
        		...
        		+ "Processing transaction...\n"
        		+ "Visa processed the payment with amount of 10.00.\n"
        		+ "Booking Successful for facility 06-12-2023 15\n"
        		+ admin.printTime()
        		+ "\n"
        		+ "Press 1 to make a booking.\n"
        		+ "Press 2 to view bookings.\n"
    ...
    public void testMain_18() throws Exception {
        ...
        String expectedOutput = "Shahbagh Sports Complex\n"
        		...
        		+ "Input: "
        		+ "Enter date of booking (DD-MM-YYYY): "
        		+ "Available time slots for 07-12-2023:\n"
        		+ "Time slot 9:00 is available.\n"
        		+ "Time slot 10:00 is available.\n"
        		+ "Time slot 11:00 is available.\n"
        		+ "Time slot 12:00 is available.\n"
        		...
        		+ "Processing transaction...\n"
        		+ "Visa processed the payment with amount of 10.00.\n"
        		+ "Booking Successful for facility 07-12-2023 19\n"
        		+ admin.printTime()
        		+ "\n"
        		+ "Press 1 to make a booking.\n"
        		+ "Press 2 to view bookings.\n"
        		...
        		+ "Membership Type: Standard Member\n"
        		+ "Booking ID: 1\n"
        		+ "Booking Date: 07-12-2023\n"
        		+ "Booking Start Time: 19\n"
        		+ "Facility: Swimming Pool\n"
        		+ "Input: "
        		+ "Booking cancelled for 07-12-2023 19\n"
        		+ "Visa processed the refund with amount of 10.00.\n"
        		+ admin.printTime()
        		+ "\n"
        		+ "Press 1 to make a booking.\n"
        		+ "Press 2 to view bookings.\n"
